            ...
            <Grid container style={{ minWidth: '100vh' }}>
                ...
                <Grid container item xs={12} sm={6} alignItems="center" direction="column" justify="space-around" style={{ padding: 10 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: "column" }}>
                        ...
                        <TextField margin="normal" label="Password" type={passwordShown ? "text" : "password"} style={{ textAlign: "center" }} InputProps={{ startAdornment: <InputAdornment position="start"><LockRounded />
                        <Visibility style={{ position: "absolute", right: 0 }} onClick={togglePasswordVisiblity}/></InputAdornment> }}></TextField>

                        <TextField margin="normal" label="Confirm Password" type={passwordShown ? "text" : "password"} style={{ textAlign: "center" }} InputProps={{ startAdornment: <InputAdornment position="start"><LockRounded />
                        <Visibility style={{ position: "absolute", right: 0 }} onClick={togglePasswordVisiblity}></Visibility></InputAdornment> }}></TextField>
