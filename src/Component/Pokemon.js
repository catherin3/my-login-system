    ...
    const generatePokemonJSX = (pokemon) => {
        ...
        return (
            <>
                ...
                <Typography style={{ fontSize: 20, padding: 5 }}>
                    {"Species: "}
                    <Link href={species.url}>{species.name} </Link>
                </Typography>
                <Typography style={{ fontSize: 20, padding: 5 }}>Height: {height} </Typography>
                <Typography style={{ fontSize: 20, padding: 5 }}>Weight: {weight} </Typography>
